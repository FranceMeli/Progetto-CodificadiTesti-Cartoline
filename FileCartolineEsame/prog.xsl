    ...
    <xsl:template match="/">
        <html>
           ...
           <xsl:element name="div">
               ...
               <div id="buttons">
                   <select id="pulsanti">
                       <option id="p187" class="Cartolina"  value="Cart1" selected="selected">067</option> 
                       <option id="p067" class="Cartolina"  value="Cart2">187</option> 
                       <option id="p197" class="Cartolina"  value="Cart3">197</option>  
                   </select>
                            ...
                            <xsl:element name="div">
                                ...
                                <xsl:element name="div">
                                 ...
                                 <xsl:element name="div">
                                     ...
                                     <xsl:element name="div">
                                         <xsl:attribute name="class">div_fronte</xsl:attribute>
                        ...
                        <xsl:for-each select="//tei:surface[position()=2]/tei:graphic">
                            <xsl:element name="div">
                                ...
                                <xsl:element name="div">
                                    ...
                                    <xsl:element name="div">
                                        <xsl:attribute name="class">div_retro</xsl:attribute>
                                        ...
                                        <xsl:if test="@xml:id='retro2'">  
                                            ...
                                            <xsl:element name="div">
                                                ...
                                                <xsl:element name="div">
                                                    <xsl:attribute name="class">p_retro</xsl:attribute>
                                                    <xsl:element name="div">
                                                    <xsl:attribute name="class">p_stampe</xsl:attribute>
                                        ...
                                        <xsl:if test="@xml:id='retro3'">
                                            ...
                                            <xsl:element name="div">
                                                ...
                                                <xsl:element name="div">
                                                    ...
                                                    <b>Stampe presenti sulla cartolina</b><br/>
                                                    <xsl:element name="p">
                                                        <xsl:attribute name="class"><xsl:value-of select="//tei:div[@xml:id='ScritteR3']/tei:ab[position()=1]/tei:s/@xml:id"/></xsl:attribute>
                                                       <xsl:value-of select="/teiCorpus/TEI[3]/tei:text/tei:front/tei:div/tei:div[@xml:id='ScritteR3']/tei:ab[position()=1]"/><br/>
                                                    </xsl:element>
                                                    <xsl:element name="div">
                                                        <xsl:attribute name="class"><xsl:value-of select="//tei:div[@xml:id='ScritteR3']/tei:ab[position()=2]/@xml:id"/></xsl:attribute>
                                                        <xsl:apply-templates select="/teiCorpus/TEI[3]/tei:text/tei:front/tei:div/tei:div[@xml:id='ScritteR3']/tei:ab[position()=2]"/><br/>
                                                    </xsl:element>
                                                    <xsl:element name="p">
                                                        <xsl:attribute name="class"><xsl:value-of select="//tei:div[@xml:id='ScritteR3']/tei:ab[position()=3]/tei:hi/tei:s/@xml:id"/></xsl:attribute>
